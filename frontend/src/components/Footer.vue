<template>
  <footer
    class="bg-transparent glow pb-1 text-sm leading-3 tracking-tighter px-2 w-full bottom-0 flex justify-between h-[50px] left-0 items-end"
    ...
    <div class=" flex flex-col  tracking-[-.1em]  text-[18px] leading-2.5  items-center text-white">
    ...
    <div class="flex flex-col tracking-[-.1em]  text-[18px] leading-2.5  items-center ">
    ...
    <div class="flex flex-col tracking-[-.1em]  text-[18px] leading-2.5 items-center text-white mb-4">
      <ChatPanel />
    </div>
    <div class="flex flex-col tracking-[-.1em]  text-[18px] leading-2.5  items-center text-white">
      <SpriteAnimator :animation-data="VaultAnimation" :image-url="vaultImageUrl" :width="60" :height="60"
        :frame-count="VaultAnimation.frames.length" :initial-delay-max="8" :loop-delay="7" />
